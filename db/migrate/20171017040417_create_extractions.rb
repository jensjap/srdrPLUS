class CreateExtractions < ActiveRecord::Migration[5.0]
  def change
    ...
    add_index :extractions, [:projects_study_id, :projects_users_role_id, :extraction_forms_project_id, :deleted_at], name: 'index_e_on_ps_id_pur_id_efp_id_deleted_at_uniq', unique: true, where: 'deleted_at IS NULL'
  end
end
