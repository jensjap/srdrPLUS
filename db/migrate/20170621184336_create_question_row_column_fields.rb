class CreateQuestionRowColumnFields < ActiveRecord::Migration[5.0]
  def change
    ...
    add_index :question_row_column_fields, [:question_row_column_field_type_id, :question_row_column_id, :deleted_at], name: 'index_qrcf_on_qrcft_id_qrc_id_deleted_at', where: 'deleted_at IS NULL'
  end
end
