class CreateExtractionFormsProjectsSections < ActiveRecord::Migration[5.0]
  def change
    ...
    add_index :extraction_forms_projects_sections, [:extraction_forms_project_id, :extraction_forms_projects_section_type_id, :section_id, :extraction_forms_projects_section_id, :deleted_at], name: 'index_efps_on_efp_id_efpst_id_s_id_efps_id_deleted_at', where: 'deleted_at IS NULL'
    add_index :extraction_forms_projects_sections, [:extraction_forms_project_id, :extraction_forms_projects_section_type_id, :section_id, :extraction_forms_projects_section_id, :active],     name: 'index_efps_on_efp_id_efpst_id_s_id_efps_id_active'
  end
end
