class CreateSuggestions < ActiveRecord::Migration[5.0]
  def change
    ...
    add_index :suggestions, [:suggestable_type, :suggestable_id, :user_id, :deleted_at], name: 'index_suggestions_on_type_id_user_id_deleted_at_uniq', unique: true, where: 'deleted_at IS NULL'
