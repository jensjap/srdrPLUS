class CreateResultStatisticSections < ActiveRecord::Migration[5.0]
  def change
    ...
    add_index :result_statistic_sections, [:result_statistic_section_type_id, :population_id, :deleted_at], name: 'index_rss_on_rsst_id_eefpst1rc_id_uniq', where: 'deleted_at IS NULL', unique: true
  end
end
