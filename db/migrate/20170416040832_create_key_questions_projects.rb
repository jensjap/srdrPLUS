class CreateKeyQuestionsProjects < ActiveRecord::Migration[5.0]
  def change
    ...
    add_index :key_questions_projects, [:extraction_form_id, :key_question_id, :project_id],          name: 'index_kqp_on_ef_id_kq_id_p_id', where: 'deleted_at IS NULL'
    add_index :key_questions_projects, [:extraction_form_id, :key_question_id, :project_id, :active], name: 'index_kqp_on_ef_id_kq_id_p_id_active'
  end
end
