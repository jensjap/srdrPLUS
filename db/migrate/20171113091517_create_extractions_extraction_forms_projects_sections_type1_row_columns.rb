class CreateExtractionsExtractionFormsProjectsSectionsType1RowColumns < ActiveRecord::Migration[5.0]
  def change
    ...
    add_index :extractions_extraction_forms_projects_sections_type1_row_columns, [:extractions_extraction_forms_projects_sections_type1_row_id, :deleted_at], name: 'index_eefpst1rc_on_eefpst1r_id_deleted_at', where: 'deleted_at IS NULL'
  end
end
