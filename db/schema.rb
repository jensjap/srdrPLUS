...
ActiveRecord::Schema[7.0].define(version: 2022_06_14_151542) do
  ...
  create_table "data_audits", id: :integer, charset: "utf8", force: :cascade do |t|
  ...
  create_table "extractions_projects_users_roles", id: :integer, charset: "utf8", force: :cascade do |t|
    t.integer "extraction_id"
    t.integer "projects_users_role_id"
    t.datetime "deleted_at", precision: nil
    t.boolean "active"
