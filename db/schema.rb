...
ActiveRecord::Schema[7.0].define(version: 2024_07_11_113146) do
  ...
  create_table "assignments_messages", charset: "utf8mb3", force: :cascade do |t|
    t.bigint "assignment_id", null: false
    t.bigint "message_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["assignment_id", "message_id"], name: "index_assignments_messages_on_assignment_id_and_message_id", unique: true
    t.index ["assignment_id"], name: "index_assignments_messages_on_assignment_id"
    t.index ["message_id"], name: "index_assignments_messages_on_message_id"
  end
