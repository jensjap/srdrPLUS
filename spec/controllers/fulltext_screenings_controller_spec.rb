...
RSpec.describe FulltextScreeningsController, type: :controller do
  ...
  describe 'GET #show' do
    let(:fulltext_screening) { FulltextScreening.create!(project: project, fulltext_screening_type: 'double-perpetual') }
    let(:fulltext_screening_result) do
      FulltextScreeningResult.create!(
    ...
    context 'JSON format with field-specific searches' do
      ...
      it 'searches by title with regex matching' do
        ...
        get :show, params: { id: fulltext_screening.id, query: 'title:pancreas' }, format: :json
      ...
      it 'searches by author with regex matching' do
        ...
        get :show, params: { id: fulltext_screening.id, query: 'author:kwan' }, format: :json
      ...
      it 'searches by accession_number with regex matching' do
        ...
        get :show, params: { id: fulltext_screening.id, query: 'accession_number:12345' }, format: :json
      ...
      it 'searches by year with regex matching' do
        ...
        get :show, params: { id: fulltext_screening.id, query: 'year:2020' }, format: :json
      ...
      it 'searches by user with regex matching' do
        ...
        get :show, params: { id: fulltext_screening.id, query: 'user:john' }, format: :json
      ...
      it 'searches by label with exact matching' do
        ...
        get :show, params: { id: fulltext_screening.id, query: 'label:1' }, format: :json
      ...
      it 'searches by label:null with nil value' do
        ...
        get :show, params: { id: fulltext_screening.id, query: 'label:null' }, format: :json
      ...
      it 'searches by privileged with boolean matching' do
        ...
        get :show, params: { id: fulltext_screening.id, query: 'privileged:true' }, format: :json
      ...
      it 'searches by reason with regex matching' do
        ...
        get :show, params: { id: fulltext_screening.id, query: 'reason:excluded' }, format: :json
      ...
      it 'searches by tag with regex matching' do
        ...
        get :show, params: { id: fulltext_screening.id, query: 'tag:important' }, format: :json
      ...
      it 'searches by note with regex matching' do
        ...
        get :show, params: { id: fulltext_screening.id, query: 'note:review' }, format: :json
      ...
      it 'combines multiple field searches with AND logic' do
        ...
        get :show, params: { id: fulltext_screening.id, query: 'title:pancreas author:kwan year:2020' }, format: :json
      ...
      it 'combines exact match and regex fields' do
        ...
        get :show, params: { id: fulltext_screening.id, query: 'label:1 privileged:false author:kwan' }, format: :json
      ...
      it 'escapes special regex characters' do
        ...
        get :show, params: { id: fulltext_screening.id, query: 'title:test.+*' }, format: :json
      ...
      it 'defaults to wildcard search when query is blank' do
        ...
        get :show, params: { id: fulltext_screening.id, query: '' }, format: :json
      ...
      it 'handles multiple terms for same field' do
        ...
        get :show, params: { id: fulltext_screening.id, query: 'author:kwan author:smith' }, format: :json
