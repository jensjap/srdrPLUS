...
describe ExtractionsExtractionFormsProjectsSectionsQuestionRowColumnFieldPolicy, type: :controller do
  ...
  subject { ExtractionsExtractionFormsProjectsSectionsQuestionRowColumnFieldPolicy.new(user, project) }
