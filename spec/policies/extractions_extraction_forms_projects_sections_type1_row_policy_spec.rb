...
describe ExtractionsExtractionFormsProjectsSectionsType1RowPolicy, type: :controller do
  ...
  subject { ExtractionsExtractionFormsProjectsSectionsType1RowPolicy.new(user, project) }
