...
describe QuestionRowColumnFieldsQuestionRowColumnFieldOptionPolicy, type: :controller do
  ...
  subject { QuestionRowColumnFieldsQuestionRowColumnFieldOptionPolicy.new(user, project) }
