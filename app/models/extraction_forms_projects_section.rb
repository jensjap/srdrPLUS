...
#      self.extraction_forms_projects_section_type_id != 2
  ...
  def parent_type
    errors[:base] << ('Parent Type must be of Type 1') unless self.extraction_forms_projects_section_type1.nil? ||
      self.extraction_forms_projects_section_type1.extraction_forms_projects_section_type_id == 1
  end
end
