class ExtractionFormsProjectsSection < ApplicationRecord
  ...
  belongs_to :type_i, class_name: 'ExtractionFormsProjectsSection',
                      foreign_key: 'extraction_forms_projects_section_id',
                      optional: true

  has_one :ordering, as: :orderable, dependent: :destroy

  has_many :type_ii_s, class_name:  'ExtractionFormsProjectsSection',
                       foreign_key: 'extraction_forms_projects_section_id'
  ...
  def parent_type
    errors[:base] << ('Parent Type must be of Type I') unless self.type_i.nil? || self.type_i.extraction_forms_projects_section_type_id == 1
  end
end
