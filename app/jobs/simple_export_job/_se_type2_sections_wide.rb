...
def build_type2_sections_wide(kq_ids=[])
  ...
  efp.extraction_forms_projects_sections.each do |efps|
    ...
    # Add a new sheet.
    @p.workbook.add_worksheet(name: efps.section.name.try(:truncate, 24)) do |sheet|
      ...
      @project.extractions.each do |extraction|
        ...
        # to :id, type1: :id.
        eefpst1s = (eefps.extraction_forms_projects_section.try(:extraction_forms_projects_section_option).by_type1 &&
