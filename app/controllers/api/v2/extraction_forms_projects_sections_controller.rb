class Api::V2::ExtractionFormsProjectsSectionsController < Api::V2::BaseController
  ...
  api :GET, '/v2/extraction_forms_projects_section/:id.json', 'Returns full description of extraction form section template.'
  param_group :resource_id, Api::V2::BaseController
  def show
    authorize(
      @extraction_forms_projects_section.project,
      policy_class: ExtractionFormsProjectsSectionPolicy
    )
  end
