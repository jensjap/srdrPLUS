    ...
    params
      ...
      .permit(
        ...
        { sd_result_items_attributes: [:sd_key_question_id, :_destroy, :id,
                                       ...
                                       { sd_pairwise_meta_analytic_results_attributes: [:name, :_destroy, :id, { sd_meta_data_figures_attributes: [:id, :_destroy, :p_type, :alt_text, :outcome_type, :intervention_name, :comparator_name, :effect_size_measure_name, :overall_effect_size, :overall_95_ci_low, :overall_95_ci_high, :overall_i_squared, { pictures: [] }] }, { sd_outcome_names: [] }] },
