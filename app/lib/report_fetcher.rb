...
class ReportFetcher
  ...
  def self.run_daily_update
    ...
    list_or_create_report_directory

    puts 'downloading or refreshing report directory file'
    download_or_refresh_report_directory_file

    puts 'list or download new report tars'
    list_or_download_new_reports_tars(read_list_of_cer_report_metas)
  end
  ...
  def self.list_or_download_new_reports_tars(cer_report_metas)
    ...
    cer_report_metas.each do |report_meta|
      ...
      if File.exist?(report_download_location)
  ...
  def self.update_htmls
    report_metas = read_list_of_cer_report_metas
