...
var Body = (function (_React$Component) {
  ...
  function Body(props, context) {
    ...
    _get(Object.getPrototypeOf(Body.prototype), "constructor", this).call(this, props, context);
  }
  ...
  _createClass(Body, [{
    ...
    value: function render() {
      return React.createElement(
        "div",
        null,
        React.createElement(NewExtractionFormsProjectsSection, null),
        React.createElement(ExtractionFormsProjectsSections, null)
      );
    }
  }]);
...
var ExtractionFormsProjectsSections = (function (_React$Component) {
  _inherits(ExtractionFormsProjectsSections, _React$Component);

  function ExtractionFormsProjectsSections(props, context) {
    _classCallCheck(this, ExtractionFormsProjectsSections);

    _get(Object.getPrototypeOf(ExtractionFormsProjectsSections.prototype), 'constructor', this).call(this, props, context);
  ...
  _createClass(ExtractionFormsProjectsSections, [{
    ...
    value: function componentDidMount() {
      ...
      $.getJSON('/api/v1/extraction_forms_projects/1/extraction_forms_projects_sections.json', function (response) {
        _this.setState({ sections: response });
      });
  ...
  return ExtractionFormsProjectsSections;
})(React.Component);
var _createClass = (function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; })();
...
var NewExtractionFormsProjectsSection = (function (_React$Component) {
  _inherits(NewExtractionFormsProjectsSection, _React$Component);

  function NewExtractionFormsProjectsSection(props, context) {
    _classCallCheck(this, NewExtractionFormsProjectsSection);

    _get(Object.getPrototypeOf(NewExtractionFormsProjectsSection.prototype), 'constructor', this).call(this, props, context);

    this.handleClick = this.handleClick.bind(this);
  }

  _createClass(NewExtractionFormsProjectsSection, [{
    key: 'handleClick',
    ...
    value: function render() {
      return React.createElement(
        'div',
        null,
        React.createElement('input', { ref: 'name', placeholder: 'Enter the name of the new section' }),
        React.createElement(
          'button',
...
// The line below causes an error: Only a ReactOwner can have refs because React gets loaded twice.
